...
import {
  ...
  PlusCircle, Users, Bell, Menu, X, GraduationCap, LogOut
} from "lucide-react";
...
const sidebarLinks = [
  ...
  { label: "Upload Lecture", href: "/teacher/upload", icon: PlusCircle },
        ...
        <div className="h-16 flex items-center px-6 border-b border-white/10">
          <Link href="/teacher/dashboard" className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-sm tracking-wide">
              TEACHER <span className="text-teal-400">PORTAL</span>
            </span>
          </Link>
        </div>
