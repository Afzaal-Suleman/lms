...
import {
  LayoutDashboard, BookOpen, Users, ShieldAlert,
  CreditCard, MessageSquare, Settings, Bell, Menu, X, GraduationCap, LogOut
} from "lucide-react";
...
const sidebarLinks = [
  ...
  { label: "Teachers", href: "/admin/teachers", icon: ShieldAlert },
